...
public class Recipe_process extends AppCompatActivity {
    ...
    private void getAccessToken() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Recipe_process.this,error.toString(),Toast.LENGTH_SHORT).show();
    ...
    private void getRecipeOfTheDay(String token) {
        RequestQueue r = Volley.newRequestQueue(Recipe_process.this);
        StringRequest sr = new StringRequest(Request.Method.GET, recipe_url_rpd, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Glide.with(Recipe_process.this)
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Recipe_process.this,error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
