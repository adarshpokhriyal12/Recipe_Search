        ...
        StringRequest sr = new StringRequest(Request.Method.GET, recipe_url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if(recs.length()==0)
                        Toast.makeText(Nutrition_Search.this,"No Match",Toast.LENGTH_SHORT).show();
...
//              });
    ...
    public void recipeOfDayCLick(View view) throws JSONException {
        Intent i =  new Intent(Nutrition_Search.this,Recipe_Details.class);
    ...
    private void getAccessToken() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Nutrition_Search.this,error.toString(),Toast.LENGTH_SHORT).show();
        ...
        StringRequest sr = new StringRequest(Request.Method.GET, recipe_url_rpd, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Glide.with(Nutrition_Search.this)
